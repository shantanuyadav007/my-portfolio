            ...
            <div className='flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-screen'>
                ...
                <div className='flex justify-center items-center'>
                    <form action="" method="POST" className='flex flex-col w-full md:w-1/2'>
                        ...
                        <button data-aos="zoom-in" data-aos-duration="1000" type="submit" className='text-white bg-gradient-to-b from-cyan-500 to-blue-500 px-6 py-3 my-8 mx-auto flex items-center rounded-md hover:scale-110 duration-300'>Let's Connect</button>
                    </form>
                </div>
            </div>
        </div>
